...
int main(int argc, char *argv[])
{
    ...
    Config config = Config({{"output", "/home/pi/hapi"},
                            {"trigger_type", "1"},
                            {"arm_pin", "26"},
                            {"delay_pin0", "7"},
                            {"delay_pin1", "0"},
    ...
    try
    {
        ...
        board.set_delay_pins(config.get_int("delay_pin0"),
                             config.get_int("delay_pin1"),
                             config.get_int("delay_pin2"),
                             config.get_int("delay_pin3"));
        board.set_exp_pins(config.get_int("exp_pin0"),
                           config.get_int("exp_pin1"),
                           config.get_int("exp_pin2"),
                           config.get_int("exp_pin3"));
        board.set_pulse_pins(config.get_int("pulse_pin0"),
                             config.get_int("pulse_pin1"),
                             config.get_int("pulse_pin2"),
                             config.get_int("pulse_pin3"),
